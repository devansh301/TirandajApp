...
import '../services/mycategory3.dart';
import '../services/post.dart';

class Category3Post extends StatefulWidget {
  const Category3Post({Key? key}) : super(key: key);

  @override
  State<Category3Post> createState() => _Category3PostState();
}

class _Category3PostState extends State<Category3Post> with AutomaticKeepAliveClientMixin<Category3Post>{

  MyCategory3 categorypostService = MyCategory3();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FutureBuilder<List>(
        future: categorypostService.getCategory3Post(),
