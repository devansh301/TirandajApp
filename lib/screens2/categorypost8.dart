...
import '../services/mycategory8.dart';
import '../services/post.dart';

class Category8Post extends StatefulWidget {
  const Category8Post({Key? key}) : super(key: key);

  @override
  State<Category8Post> createState() => _Category8PostState();
}

class _Category8PostState extends State<Category8Post> {

  MyCategory8 categorypostService = MyCategory8();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FutureBuilder<List>(
        future: categorypostService.getCategory8Post(),
