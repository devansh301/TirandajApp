...
import '../services/mycategory4.dart';
import '../services/post.dart';

class Category4Post extends StatefulWidget {
  const Category4Post({Key? key}) : super(key: key);

  @override
  State<Category4Post> createState() => _Category4PostState();
}

class _Category4PostState extends State<Category4Post> {

  MyCategory4 categorypostService = MyCategory4();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FutureBuilder<List>(
        future: categorypostService.getCategory4Post(),
