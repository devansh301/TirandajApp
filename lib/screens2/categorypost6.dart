...
import '../services/mycategory6.dart';
import '../services/post.dart';

class Category6Post extends StatefulWidget {
  const Category6Post({Key? key}) : super(key: key);

  @override
  State<Category6Post> createState() => _Category6PostState();
}

class _Category6PostState extends State<Category6Post> {

  MyCategory6 categorypostService = MyCategory6();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FutureBuilder<List>(
        future: categorypostService.getCategory6Post(),
