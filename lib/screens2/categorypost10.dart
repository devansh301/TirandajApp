...
import '../services/mycategory10.dart';
import '../services/post.dart';

class Category10Post extends StatefulWidget {
  const Category10Post({Key? key}) : super(key: key);

  @override
  State<Category10Post> createState() => _Category10PostState();
}

class _Category10PostState extends State<Category10Post> {
  //with AutomaticKeepAliveClientMixin<Category10Post>{

  MyCategory10 categorypostService = MyCategory10();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FutureBuilder<List>(
        future: categorypostService.getCategory10Post(),
